...
assert_doc_contains(ROADMAP.md
    ...
    "raw-foreign-rules"
    "status: in_progress"
    "configured Windows x64 suite's current 462 CTest registrations"
    "Built-in substrate is complete for the current polished subset."
    ...
    "Do not call the subset releasable while docs and release contracts still describe stale implementation status"
    "## Phase 9: Self-Hosting Bootstrap"
    "It is not a compiler implementation and there is no stage-1/stage-2 harness yet."
    "docs/BOOTSTRAP_PLAN.md"
)

assert_doc_contains(docs/FINISH_EVIDENT_DESIGN.md
    "Background design note. `ROADMAP.md` is the source of truth for accepted compiler finish status and phase ordering."
)
...
assert_doc_does_not_contain(ROADMAP.md
