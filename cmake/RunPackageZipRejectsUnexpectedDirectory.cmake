...
set(work_dir "${BUILD_DIR}/package-zip-negative-dir-${test_suffix}")
set(package_root "evident-negative-dir-windows-x64")
set(package_path "${work_dir}/${package_root}.zip")

file(MAKE_DIRECTORY
    "${work_dir}/${package_root}/bin"
    "${work_dir}/${package_root}/share/doc/evident_compiler"
    "${work_dir}/${package_root}/unexpected-empty-dir"
)
...
if(validation_result EQUAL 0)
    message(FATAL_ERROR
        "package ZIP listing validation unexpectedly accepted an unexpected directory entry\nstdout:\n${validation_stdout}\nstderr:\n${validation_stderr}")
endif()
...
foreach(required_fragment IN ITEMS
    "package ZIP contains unexpected directory entry:"
    "${package_root}/unexpected-empty-dir/")
    string(FIND "${actual_error}" "${required_fragment}" fragment_index)
    if(fragment_index EQUAL -1)
        message(FATAL_ERROR
            "unexpected-directory validation error did not contain required fragment '${required_fragment}'\nstdout:\n${validation_stdout}\nstderr:\n${validation_stderr}")
    endif()
endforeach()
